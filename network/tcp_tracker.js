 ...
 * https://github.com/mranney/node_pcap/blob/master/tcp_tracker.js
 */
    ...
    if (src === this.src) { // this packet came from the active opener / client
        ...
        if (tcp.dataLength > 0) {
            if (this.send_packets[tcp.seqno + tcp.dataLength]) {
                this.emit("retransmit", this, "send", tcp.seqno + tcp.dataLength, tcp.dataLength);
                ...
                this.emit("data send", this, tcp.data, tcp.dataLength);
            }
        ...
        if (tcp.dataLength > 0) {
            if (this.recv_packets[tcp.seqno + tcp.dataLength]) {
                this.emit("retransmit", this, "recv", tcp.seqno + tcp.dataLength, tcp.dataLength);
                ...
                this.emit("data recv", this, tcp.data, tcp.dataLength);
            }
...
module.exports.TCPTracker = TCPTracker;
